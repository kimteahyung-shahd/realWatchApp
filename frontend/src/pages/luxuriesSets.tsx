...
function luxuriesSets (){
    ...
    useEffect(()=>{
        const FetchData = async () =>{
            try{
                ...
                const setsProducts = data.filter((product: any) => product.luxuriesSets);
    ...
    return(
       <section>
            <div className="bg-[url('/1332184.jpg')] flex items-center justify-center bg-cover bg-center mb-10 h-[300px]">
                <h1 className="text-center font-[600] text-white py-10 text-4xl font-helvetica">Luxuries Sets</h1>
            </div>
